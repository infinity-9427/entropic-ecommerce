...
// Simplified form schema for immediate use
...
export default function EnhancedProductForm({ product, onSuccess, onCancel }: ProductFormProps) {
  ...
  // Update slug when name changes (basic implementation)
        ...
        render={({ field }) => (
          <div>
            ...
            <input
              {...field}
              type="text"
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors uppercase"
      ...
      <Controller
        ...
        render={({ field: { value, onChange, ...field } }) => (
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
            <div className="flex items-center">
              <i className={`mr-3 text-xl ${value ? 'ri-download-cloud-line text-blue-500' : 'ri-box-3-line text-green-500'}`}></i>
              <div>
                <p className="font-medium text-gray-900">
                  {value ? 'Digital Product' : 'Physical Product'}
                </p>
                <p className="text-sm text-gray-600">
                  {value ? 'No shipping required' : 'Requires physical shipping'}
                </p>
              </div>
            </div>
            <button
          ...
          <div>
            ...
            <div className="flex">
              ...
              <input
                {...field}
                type="text"
                className="flex-1 px-4 py-3 border rounded-r-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors border-gray-300"
  ...
  // Render conditional fields based on active section
